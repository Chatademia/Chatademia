...
function Lectures({ isActive, color, lectureAcronym, lectureName }) {
  const colorMap = {
    red: "bg-red-500",
    blue: "bg-blue-500",
    green: "bg-green-500",
  ...
  return (
    <div className={`${isActive ? "bg-violet-50" : "bg-white"} flex p-4 rounded-xl pr-2 gap-2 place-items-center`}>
