      ...
      <div className="bg-white rounded-2xl shadow-2xl w-full max-w-lg mx-4 p-6 relative">
        ...
        <form onSubmit={handleSubmit}>
          ...
          <input
            ...
            className="w-full px-4 py-3 border-2 border-gray-200 rounded-lg text-2xl tracking-widest font-bold text-center bg-gray-50 focus:outline-none focus:border-primary transition-all mb-4 shadow-lg placeholder-gray-400"
            autoFocus
            maxLength={6}
